...
const RegionTable = () => {
  return (
    <main className="flex-1 py-10 px-2 bg-gray-50">
      <h1 className="text-xl font-bold text-center text-gray-500">ТОШКЕНТ ВИЛОЯТИ БЎЙИЧА 2025 ҲОСИЛИДАН ҒАЛЛА ҚАБУЛ ҚИЛИШНИНГ БОРИШИ</h1>
      <Table className="w-full mt-6">
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="px-4 py-2 border-2 text-center text-gray-700 font-semibold text-md bg-gray-100/50" rowSpan={3}>Туманлар</TableHead>
            <TableHead className="px-4 py-2 border-2 text-center text-gray-700 font-semibold text-md bg-gray-100/50" rowSpan={3}>шартнома бўйича, тн</TableHead>
          ...
          <TableRow>
            <TableHead colSpan={16} rowSpan={1} className="px-4 py-2 border-2 text-center text-gray-700 font-semibold text-md bg-white">вилоят ИИБ бошлиғи ҳудуди</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {[1, 2, 3].map((item, index) => (
            <TableRow key={index}>
              ...
              <TableCell className="px-4 py-2 border-2 text-center text-gray-500 font-semibold text-md bg-gray-100" ><Link href={'/grain-products/region/district'}>Yangiyo'l tumani</Link></TableCell>
