...
export default function AddModal({
  ...
  const [hasChangePaidDay, setHasChangePaidDay] = useState(false);
  const [changeBackDay, setChangeBackDay] = useState(false);
  ...
  useEffect(() => {
    setShowFinancialDirection(selectedCategory?.categoryType == "DON");
  }, [selectedCategory]);
  ...
  const onSubmit = async (data: CreateContract) => {
    ...
    //       resetForm();
    //       refetchAllContractsList();
    //       setChangeBackDay(false);
    //       setHasChangePaidDay(false)
    //       setTimeout(() => {
    //         setHasFiles(false);
    //       }, 0);
    //     },
  ...
  const onSubmitStandardContract = async (data: CreateContract) => {
    const submittingData: CreateContract = {
      ...
      hasChangePaidDay: hasChangePaidDay,
      gracePeriod: Number(data?.gracePeriod),
      payDate: data?.payDate ? Number(data?.payDate) : undefined,
                      ...
                      <div className="w-[45%] mt-0 flex gap-3 flex-col">
                        <div className="w-full mt-0 flex gap-2 flex-col">
                          <div className="flex items-center space-x-2">
                            <Switch
                              id="canChangeContractDate"
                              checked={changeBackDay}
                              onCheckedChange={setChangeBackDay}
                            />
                        ...
                        <div className="w-full mt-0 flex gap-2 flex-col">
                          <div className="flex items-center space-x-2">
                            <Switch
                              id="canChangePayDate"
                              checked={hasChangePaidDay}
                              onCheckedChange={setHasChangePaidDay}
                            />
