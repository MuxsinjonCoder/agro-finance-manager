...
import { useCreateStorageAgree } from "@/queries/grain/storage-agree";
...
const AddModal = ({ addModal, setAddModal }: PropsTypes) => {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      description: "",
      keeper: "",
      endDate: new Date(new Date().getFullYear(), 11, 1).toISOString(),
      penalty: undefined,
    },
  });
  ...
  const createStorageAgree = useCreateStorageAgree();
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    // createStorageAgree.mutate(submitingData, {
